...
class ProductRepositoryAdapterTest {
  ...
  @Mock
  private ProductJpaRepository productMORepositoryMock;
  ...
  void setUp() {
    ...
    productCrudRepository = new ProductRepositoryAdapter(
      productMORepositoryMock,
      productMapperMock);
  ...
  void shouldGetProduct() {
    ...
    given(productMapperMock.fromOptionalModel(any(Optional.class)))
  ...
  void shouldCreateProduct() {
    ...
    given(productMORepositoryMock.save(testProductEntityModel)).willReturn(testProductEntityModel);
  ...
  void shouldNotDeleteProductNotFound() {
    ...
    doThrow(EmptyResultDataAccessException.class).when(productMORepositoryMock).deleteById(TEST_ID);
